...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reviews_review', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='review_comments', null=True, to=orm['auth.User'])),
            ('session_id', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
